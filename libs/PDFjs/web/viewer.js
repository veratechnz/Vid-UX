    ...
    this.handTool = new GrabToPan({
      ...
      onActiveChanged: function(isActive) {
        ...
        if (isActive) {
          ...
          // Commented Out due to text marker not required. Changed Jared 15-03-16
          // toggleHandTool.firstElementChild.textContent =
          //   mozL10n.get('hand_tool_disable_label', null, ''); 
          // Added the following for colored icon UI adjustment:
          $('i.fa.fa-hand-paper-o.fa-lg').addClass('hand-red');
        } else {
          toggleHandTool.title =
          ...
          // Added the following for colored icon UI adjustment:
          $('i.fa.fa-hand-paper-o.fa-lg').removeClass('hand-red');
        }
      }
    });
    if (toggleHandTool) {
